importScripts('./app-version.js?v=186');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=186',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=186',
  './js/audio-runtime.js?v=186',
  './js/core.js?v=186',
  './js/metronome.js?v=186',
  './js/tuner-engine.js?v=186',
  './js/tuner.js?v=186',
  './js/scales.js?v=186',
  './js/ear-trainer.js?v=186',
  './js/rhythm-trainer.js?v=186',
  './js/recording-cache.js?v=186',
  './js/recorder.js?v=186',
  './js/practice-links.js?v=186',
  './js/jam-session.js?v=186',
  './js/app-shell.js?v=186',
  './vendor/soundtouch/soundtouch-processor.js?v=186',
  './icons/icon-192.png',
  './icons/icon-512.png',
