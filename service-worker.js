importScripts('./app-version.js?v=197');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=197',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=197',
  './js/audio-runtime.js?v=197',
  './js/core.js?v=197',
  './js/metronome.js?v=197',
  './js/tuner-engine.js?v=197',
  './js/tuner.js?v=197',
  './js/scales.js?v=197',
  './js/ear-trainer.js?v=197',
  './js/rhythm-trainer.js?v=197',
  './js/recording-cache.js?v=197',
  './js/recorder.js?v=197',
  './js/practice-links.js?v=197',
  './js/jam-session.js?v=197',
  './js/app-shell.js?v=197',
  './vendor/soundtouch/soundtouch-processor.js?v=197',
  './icons/icon-192.png',
  './icons/icon-512.png',
