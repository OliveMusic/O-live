importScripts('./app-version.js?v=184');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=184',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=184',
  './js/audio-runtime.js?v=184',
  './js/core.js?v=184',
  './js/metronome.js?v=184',
  './js/tuner-engine.js?v=184',
  './js/tuner.js?v=184',
  './js/scales.js?v=184',
  './js/ear-trainer.js?v=184',
  './js/rhythm-trainer.js?v=184',
  './js/recording-cache.js?v=184',
  './js/recorder.js?v=184',
  './js/practice-links.js?v=184',
  './js/jam-session.js?v=184',
  './js/app-shell.js?v=184',
  './vendor/soundtouch/soundtouch-processor.js?v=184',
  './icons/icon-192.png',
  './icons/icon-512.png',
