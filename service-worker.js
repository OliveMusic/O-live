importScripts('./app-version.js?v=212');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=212',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=212',
  './js/audio-runtime.js?v=212',
  './js/core.js?v=212',
  './js/metronome.js?v=212',
  './js/tuner-engine.js?v=212',
  './js/tuner.js?v=212',
  './js/scales.js?v=212',
  './js/ear-trainer.js?v=212',
  './js/rhythm-trainer.js?v=212',
  './js/recording-cache.js?v=212',
  './js/recorder.js?v=212',
  './js/practice-links.js?v=212',
  './js/jam-session.js?v=212',
  './js/app-shell.js?v=212',
  './vendor/soundtouch/soundtouch-processor.js?v=212',
  './icons/icon-192.png',
  './icons/icon-512.png',
