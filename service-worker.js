importScripts('./app-version.js?v=203');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=203',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=203',
  './js/audio-runtime.js?v=203',
  './js/core.js?v=203',
  './js/metronome.js?v=203',
  './js/tuner-engine.js?v=203',
  './js/tuner.js?v=203',
  './js/scales.js?v=203',
  './js/ear-trainer.js?v=203',
  './js/rhythm-trainer.js?v=203',
  './js/recording-cache.js?v=203',
  './js/recorder.js?v=203',
  './js/practice-links.js?v=203',
  './js/jam-session.js?v=203',
  './js/app-shell.js?v=203',
  './vendor/soundtouch/soundtouch-processor.js?v=203',
  './icons/icon-192.png',
  './icons/icon-512.png',
