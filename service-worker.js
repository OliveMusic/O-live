importScripts('./app-version.js?v=276');
...
const ASSETS = [
  ...
  './info.css?v=276',
  './manifest.json',
  './app-version.js?v=276',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=276',
  './js/audio-runtime.js?v=276',
  './js/core.js?v=276',
  './js/metronome.js?v=276',
  './js/tuner-engine.js?v=276',
  './js/tuner.js?v=276',
  './js/scales.js?v=276',
  './js/ear-trainer.js?v=276',
  './js/rhythm-trainer.js?v=276',
  './js/recording-cache.js?v=276',
  './js/recorder.js?v=276',
  './js/practice-links.js?v=276',
  './js/jam-session.js?v=276',
  './js/practice-log.js?v=276',
  './js/app-shell.js?v=276',
  './vendor/soundtouch/soundtouch-processor.js?v=276',
  './icons/icon-192.png',
  './icons/icon-512.png',
