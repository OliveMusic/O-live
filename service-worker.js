importScripts('./app-version.js?v=303');
...
const ASSETS = [
  ...
  './info.css?v=303',
  './manifest.json',
  './app-version.js?v=303',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=303',
  './js/audio-runtime.js?v=303',
  './js/core.js?v=303',
  './js/metronome.js?v=303',
  './js/tuner-engine.js?v=303',
  './js/tuner.js?v=303',
  './js/scales.js?v=303',
  './js/ear-trainer.js?v=303',
  './js/rhythm-trainer.js?v=303',
  './js/recording-cache.js?v=303',
  './js/recorder.js?v=303',
  './js/practice-links.js?v=303',
  './js/jam-session.js?v=303',
  './js/practice-log.js?v=303',
  './js/app-shell.js?v=303',
  './vendor/soundtouch/soundtouch-processor.js?v=303',
  './icons/icon-192.png',
  './icons/icon-512.png',
