importScripts('./app-version.js?v=192');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=192',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=192',
  './js/audio-runtime.js?v=192',
  './js/core.js?v=192',
  './js/metronome.js?v=192',
  './js/tuner-engine.js?v=192',
  './js/tuner.js?v=192',
  './js/scales.js?v=192',
  './js/ear-trainer.js?v=192',
  './js/rhythm-trainer.js?v=192',
  './js/recording-cache.js?v=192',
  './js/recorder.js?v=192',
  './js/practice-links.js?v=192',
  './js/jam-session.js?v=192',
  './js/app-shell.js?v=192',
  './vendor/soundtouch/soundtouch-processor.js?v=192',
  './icons/icon-192.png',
  './icons/icon-512.png',
