importScripts('./app-version.js?v=291');
...
const ASSETS = [
  ...
  './info.css?v=291',
  './manifest.json',
  './app-version.js?v=291',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=291',
  './js/audio-runtime.js?v=291',
  './js/core.js?v=291',
  './js/metronome.js?v=291',
  './js/tuner-engine.js?v=291',
  './js/tuner.js?v=291',
  './js/scales.js?v=291',
  './js/ear-trainer.js?v=291',
  './js/rhythm-trainer.js?v=291',
  './js/recording-cache.js?v=291',
  './js/recorder.js?v=291',
  './js/practice-links.js?v=291',
  './js/jam-session.js?v=291',
  './js/practice-log.js?v=291',
  './js/app-shell.js?v=291',
  './vendor/soundtouch/soundtouch-processor.js?v=291',
  './icons/icon-192.png',
  './icons/icon-512.png',
