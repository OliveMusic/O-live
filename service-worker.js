importScripts('./app-version.js?v=198');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=198',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=198',
  './js/audio-runtime.js?v=198',
  './js/core.js?v=198',
  './js/metronome.js?v=198',
  './js/tuner-engine.js?v=198',
  './js/tuner.js?v=198',
  './js/scales.js?v=198',
  './js/ear-trainer.js?v=198',
  './js/rhythm-trainer.js?v=198',
  './js/recording-cache.js?v=198',
  './js/recorder.js?v=198',
  './js/practice-links.js?v=198',
  './js/jam-session.js?v=198',
  './js/app-shell.js?v=198',
  './vendor/soundtouch/soundtouch-processor.js?v=198',
  './icons/icon-192.png',
  './icons/icon-512.png',
