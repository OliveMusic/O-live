importScripts('./app-version.js?v=304');
...
const ASSETS = [
  ...
  './info.css?v=304',
  './manifest.json',
  './app-version.js?v=304',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=304',
  './js/audio-runtime.js?v=304',
  './js/core.js?v=304',
  './js/metronome.js?v=304',
  './js/tuner-engine.js?v=304',
  './js/tuner.js?v=304',
  './js/scales.js?v=304',
  './js/ear-trainer.js?v=304',
  './js/rhythm-trainer.js?v=304',
  './js/recording-cache.js?v=304',
  './js/recorder.js?v=304',
  './js/practice-links.js?v=304',
  './js/jam-session.js?v=304',
  './js/practice-log.js?v=304',
  './js/app-shell.js?v=304',
  './vendor/soundtouch/soundtouch-processor.js?v=304',
  './icons/icon-192.png',
  './icons/icon-512.png',
