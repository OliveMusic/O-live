importScripts('./app-version.js?v=219');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=219',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=219',
  './js/audio-runtime.js?v=219',
  './js/core.js?v=219',
  './js/metronome.js?v=219',
  './js/tuner-engine.js?v=219',
  './js/tuner.js?v=219',
  './js/scales.js?v=219',
  './js/ear-trainer.js?v=219',
  './js/rhythm-trainer.js?v=219',
  './js/recording-cache.js?v=219',
  './js/recorder.js?v=219',
  './js/practice-links.js?v=219',
  './js/jam-session.js?v=219',
  './js/app-shell.js?v=219',
  './vendor/soundtouch/soundtouch-processor.js?v=219',
  './icons/icon-192.png',
  './icons/icon-512.png',
