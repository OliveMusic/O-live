importScripts('./app-version.js?v=253');
...
const ASSETS = [
  ...
  './info.css?v=253',
  './manifest.json',
  './app-version.js?v=253',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=253',
  './js/audio-runtime.js?v=253',
  './js/core.js?v=253',
  './js/metronome.js?v=253',
  './js/tuner-engine.js?v=253',
  './js/tuner.js?v=253',
  './js/scales.js?v=253',
  './js/ear-trainer.js?v=253',
  './js/rhythm-trainer.js?v=253',
  './js/recording-cache.js?v=253',
  './js/recorder.js?v=253',
  './js/practice-links.js?v=253',
  './js/jam-session.js?v=253',
  './js/practice-log.js?v=253',
  './js/app-shell.js?v=253',
  './vendor/soundtouch/soundtouch-processor.js?v=253',
  './icons/icon-192.png',
  './icons/icon-512.png',
