importScripts('./app-version.js?v=215');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=215',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=215',
  './js/audio-runtime.js?v=215',
  './js/core.js?v=215',
  './js/metronome.js?v=215',
  './js/tuner-engine.js?v=215',
  './js/tuner.js?v=215',
  './js/scales.js?v=215',
  './js/ear-trainer.js?v=215',
  './js/rhythm-trainer.js?v=215',
  './js/recording-cache.js?v=215',
  './js/recorder.js?v=215',
  './js/practice-links.js?v=215',
  './js/jam-session.js?v=215',
  './js/app-shell.js?v=215',
  './vendor/soundtouch/soundtouch-processor.js?v=215',
  './icons/icon-192.png',
  './icons/icon-512.png',
