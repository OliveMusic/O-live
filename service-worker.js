importScripts('./app-version.js?v=194');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=194',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=194',
  './js/audio-runtime.js?v=194',
  './js/core.js?v=194',
  './js/metronome.js?v=194',
  './js/tuner-engine.js?v=194',
  './js/tuner.js?v=194',
  './js/scales.js?v=194',
  './js/ear-trainer.js?v=194',
  './js/rhythm-trainer.js?v=194',
  './js/recording-cache.js?v=194',
  './js/recorder.js?v=194',
  './js/practice-links.js?v=194',
  './js/jam-session.js?v=194',
  './js/app-shell.js?v=194',
  './vendor/soundtouch/soundtouch-processor.js?v=194',
  './icons/icon-192.png',
  './icons/icon-512.png',
