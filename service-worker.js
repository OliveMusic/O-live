importScripts('./app-version.js?v=269');
...
const ASSETS = [
  ...
  './info.css?v=269',
  './manifest.json',
  './app-version.js?v=269',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=269',
  './js/audio-runtime.js?v=269',
  './js/core.js?v=269',
  './js/metronome.js?v=269',
  './js/tuner-engine.js?v=269',
  './js/tuner.js?v=269',
  './js/scales.js?v=269',
  './js/ear-trainer.js?v=269',
  './js/rhythm-trainer.js?v=269',
  './js/recording-cache.js?v=269',
  './js/recorder.js?v=269',
  './js/practice-links.js?v=269',
  './js/jam-session.js?v=269',
  './js/practice-log.js?v=269',
  './js/app-shell.js?v=269',
  './vendor/soundtouch/soundtouch-processor.js?v=269',
  './icons/icon-192.png',
  './icons/icon-512.png',
