importScripts('./app-version.js?v=274');
...
const ASSETS = [
  ...
  './info.css?v=274',
  './manifest.json',
  './app-version.js?v=274',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=274',
  './js/audio-runtime.js?v=274',
  './js/core.js?v=274',
  './js/metronome.js?v=274',
  './js/tuner-engine.js?v=274',
  './js/tuner.js?v=274',
  './js/scales.js?v=274',
  './js/ear-trainer.js?v=274',
  './js/rhythm-trainer.js?v=274',
  './js/recording-cache.js?v=274',
  './js/recorder.js?v=274',
  './js/practice-links.js?v=274',
  './js/jam-session.js?v=274',
  './js/practice-log.js?v=274',
  './js/app-shell.js?v=274',
  './vendor/soundtouch/soundtouch-processor.js?v=274',
  './icons/icon-192.png',
  './icons/icon-512.png',
