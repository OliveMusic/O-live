importScripts('./app-version.js?v=177');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=177',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=177',
  './js/audio-runtime.js?v=177',
  './js/core.js?v=177',
  './js/metronome.js?v=177',
  './js/tuner-engine.js?v=177',
  './js/tuner.js?v=177',
  './js/scales.js?v=177',
  './js/ear-trainer.js?v=177',
  './js/rhythm-trainer.js?v=177',
  './js/recording-cache.js?v=177',
  './js/recorder.js?v=177',
  './js/jam-session.js?v=177',
  './js/app-shell.js?v=177',
  './vendor/soundtouch/soundtouch-processor.js?v=177',
  './icons/icon-192.png',
  './icons/icon-512.png',
