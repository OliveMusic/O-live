importScripts('./app-version.js?v=213');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=213',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=213',
  './js/audio-runtime.js?v=213',
  './js/core.js?v=213',
  './js/metronome.js?v=213',
  './js/tuner-engine.js?v=213',
  './js/tuner.js?v=213',
  './js/scales.js?v=213',
  './js/ear-trainer.js?v=213',
  './js/rhythm-trainer.js?v=213',
  './js/recording-cache.js?v=213',
  './js/recorder.js?v=213',
  './js/practice-links.js?v=213',
  './js/jam-session.js?v=213',
  './js/app-shell.js?v=213',
  './vendor/soundtouch/soundtouch-processor.js?v=213',
  './icons/icon-192.png',
  './icons/icon-512.png',
