importScripts('./app-version.js?v=249');
...
const ASSETS = [
  ...
  './info.css?v=249',
  './manifest.json',
  './app-version.js?v=249',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=249',
  './js/audio-runtime.js?v=249',
  './js/core.js?v=249',
  './js/metronome.js?v=249',
  './js/tuner-engine.js?v=249',
  './js/tuner.js?v=249',
  './js/scales.js?v=249',
  './js/ear-trainer.js?v=249',
  './js/rhythm-trainer.js?v=249',
  './js/recording-cache.js?v=249',
  './js/recorder.js?v=249',
  './js/practice-links.js?v=249',
  './js/jam-session.js?v=249',
  './js/practice-log.js?v=249',
  './js/app-shell.js?v=249',
  './vendor/soundtouch/soundtouch-processor.js?v=249',
  './icons/icon-192.png',
  './icons/icon-512.png',
