importScripts('./app-version.js?v=321');
...
const ASSETS = [
  ...
  './info.css?v=321',
  './manifest.json',
  './app-version.js?v=321',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=321',
  './js/audio-runtime.js?v=321',
  './js/core.js?v=321',
  './js/metronome.js?v=321',
  './js/tuner-engine.js?v=321',
  './js/tuner.js?v=321',
  './js/scales.js?v=321',
  './js/chord-engine.js?v=321',
  './js/chords.js?v=321',
  './js/ear-trainer.js?v=321',
  './js/rhythm-trainer.js?v=321',
  './js/recording-cache.js?v=321',
  './js/recorder.js?v=321',
  './js/practice-links.js?v=321',
  './js/jam-session.js?v=321',
  './js/practice-log.js?v=321',
  './js/app-shell.js?v=321',
  './vendor/soundtouch/soundtouch-processor.js?v=321',
  './icons/icon-192.png',
  './icons/icon-512.png',
