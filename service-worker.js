importScripts('./app-version.js?v=224');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=224',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=224',
  './js/audio-runtime.js?v=224',
  './js/core.js?v=224',
  './js/metronome.js?v=224',
  './js/tuner-engine.js?v=224',
  './js/tuner.js?v=224',
  './js/scales.js?v=224',
  './js/ear-trainer.js?v=224',
  './js/rhythm-trainer.js?v=224',
  './js/recording-cache.js?v=224',
  './js/recorder.js?v=224',
  './js/practice-links.js?v=224',
  './js/jam-session.js?v=224',
  './js/app-shell.js?v=224',
  './vendor/soundtouch/soundtouch-processor.js?v=224',
  './icons/icon-192.png',
  './icons/icon-512.png',
