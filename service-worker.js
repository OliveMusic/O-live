importScripts('./app-version.js?v=289');
...
const ASSETS = [
  ...
  './info.css?v=289',
  './manifest.json',
  './app-version.js?v=289',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=289',
  './js/audio-runtime.js?v=289',
  './js/core.js?v=289',
  './js/metronome.js?v=289',
  './js/tuner-engine.js?v=289',
  './js/tuner.js?v=289',
  './js/scales.js?v=289',
  './js/ear-trainer.js?v=289',
  './js/rhythm-trainer.js?v=289',
  './js/recording-cache.js?v=289',
  './js/recorder.js?v=289',
  './js/practice-links.js?v=289',
  './js/jam-session.js?v=289',
  './js/practice-log.js?v=289',
  './js/app-shell.js?v=289',
  './vendor/soundtouch/soundtouch-processor.js?v=289',
  './icons/icon-192.png',
  './icons/icon-512.png',
