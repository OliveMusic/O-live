importScripts('./app-version.js?v=292');
...
const ASSETS = [
  ...
  './info.css?v=292',
  './manifest.json',
  './app-version.js?v=292',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=292',
  './js/audio-runtime.js?v=292',
  './js/core.js?v=292',
  './js/metronome.js?v=292',
  './js/tuner-engine.js?v=292',
  './js/tuner.js?v=292',
  './js/scales.js?v=292',
  './js/ear-trainer.js?v=292',
  './js/rhythm-trainer.js?v=292',
  './js/recording-cache.js?v=292',
  './js/recorder.js?v=292',
  './js/practice-links.js?v=292',
  './js/jam-session.js?v=292',
  './js/practice-log.js?v=292',
  './js/app-shell.js?v=292',
  './vendor/soundtouch/soundtouch-processor.js?v=292',
  './icons/icon-192.png',
  './icons/icon-512.png',
