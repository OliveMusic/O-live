importScripts('./app-version.js?v=277');
...
const ASSETS = [
  ...
  './info.css?v=277',
  './manifest.json',
  './app-version.js?v=277',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=277',
  './js/audio-runtime.js?v=277',
  './js/core.js?v=277',
  './js/metronome.js?v=277',
  './js/tuner-engine.js?v=277',
  './js/tuner.js?v=277',
  './js/scales.js?v=277',
  './js/ear-trainer.js?v=277',
  './js/rhythm-trainer.js?v=277',
  './js/recording-cache.js?v=277',
  './js/recorder.js?v=277',
  './js/practice-links.js?v=277',
  './js/jam-session.js?v=277',
  './js/practice-log.js?v=277',
  './js/app-shell.js?v=277',
  './vendor/soundtouch/soundtouch-processor.js?v=277',
  './icons/icon-192.png',
  './icons/icon-512.png',
