importScripts('./app-version.js?v=173');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=173',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=173',
  './js/audio-runtime.js?v=173',
  './js/core.js?v=173',
  './js/metronome.js?v=173',
  './js/tuner-engine.js?v=173',
  './js/tuner.js?v=173',
  './js/scales.js?v=173',
  './js/ear-trainer.js?v=173',
  './js/rhythm-trainer.js?v=173',
  './js/recording-cache.js?v=173',
  './js/recorder.js?v=173',
  './js/jam-session.js?v=173',
  './js/app-shell.js?v=173',
  './vendor/soundtouch/soundtouch-processor.js?v=173',
  './icons/icon-192.png',
  './icons/icon-512.png',
