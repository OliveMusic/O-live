importScripts('./app-version.js?v=182');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=182',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=182',
  './js/audio-runtime.js?v=182',
  './js/core.js?v=182',
  './js/metronome.js?v=182',
  './js/tuner-engine.js?v=182',
  './js/tuner.js?v=182',
  './js/scales.js?v=182',
  './js/ear-trainer.js?v=182',
  './js/rhythm-trainer.js?v=182',
  './js/recording-cache.js?v=182',
  './js/recorder.js?v=182',
  './js/practice-links.js?v=182',
  './js/jam-session.js?v=182',
  './js/app-shell.js?v=182',
  './vendor/soundtouch/soundtouch-processor.js?v=182',
  './icons/icon-192.png',
  './icons/icon-512.png',
