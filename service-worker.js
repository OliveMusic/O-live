importScripts('./app-version.js?v=298');
...
const ASSETS = [
  ...
  './info.css?v=298',
  './manifest.json',
  './app-version.js?v=298',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=298',
  './js/audio-runtime.js?v=298',
  './js/core.js?v=298',
  './js/metronome.js?v=298',
  './js/tuner-engine.js?v=298',
  './js/tuner.js?v=298',
  './js/scales.js?v=298',
  './js/ear-trainer.js?v=298',
  './js/rhythm-trainer.js?v=298',
  './js/recording-cache.js?v=298',
  './js/recorder.js?v=298',
  './js/practice-links.js?v=298',
  './js/jam-session.js?v=298',
  './js/practice-log.js?v=298',
  './js/app-shell.js?v=298',
  './vendor/soundtouch/soundtouch-processor.js?v=298',
  './icons/icon-192.png',
  './icons/icon-512.png',
