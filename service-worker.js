importScripts('./app-version.js?v=261');
...
const ASSETS = [
  ...
  './info.css?v=261',
  './manifest.json',
  './app-version.js?v=261',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=261',
  './js/audio-runtime.js?v=261',
  './js/core.js?v=261',
  './js/metronome.js?v=261',
  './js/tuner-engine.js?v=261',
  './js/tuner.js?v=261',
  './js/scales.js?v=261',
  './js/ear-trainer.js?v=261',
  './js/rhythm-trainer.js?v=261',
  './js/recording-cache.js?v=261',
  './js/recorder.js?v=261',
  './js/practice-links.js?v=261',
  './js/jam-session.js?v=261',
  './js/practice-log.js?v=261',
  './js/app-shell.js?v=261',
  './vendor/soundtouch/soundtouch-processor.js?v=261',
  './icons/icon-192.png',
  './icons/icon-512.png',
