importScripts('./app-version.js?v=272');
...
const ASSETS = [
  ...
  './info.css?v=272',
  './manifest.json',
  './app-version.js?v=272',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=272',
  './js/audio-runtime.js?v=272',
  './js/core.js?v=272',
  './js/metronome.js?v=272',
  './js/tuner-engine.js?v=272',
  './js/tuner.js?v=272',
  './js/scales.js?v=272',
  './js/ear-trainer.js?v=272',
  './js/rhythm-trainer.js?v=272',
  './js/recording-cache.js?v=272',
  './js/recorder.js?v=272',
  './js/practice-links.js?v=272',
  './js/jam-session.js?v=272',
  './js/practice-log.js?v=272',
  './js/app-shell.js?v=272',
  './vendor/soundtouch/soundtouch-processor.js?v=272',
  './icons/icon-192.png',
  './icons/icon-512.png',
