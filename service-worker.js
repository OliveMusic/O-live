importScripts('./app-version.js?v=201');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=201',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=201',
  './js/audio-runtime.js?v=201',
  './js/core.js?v=201',
  './js/metronome.js?v=201',
  './js/tuner-engine.js?v=201',
  './js/tuner.js?v=201',
  './js/scales.js?v=201',
  './js/ear-trainer.js?v=201',
  './js/rhythm-trainer.js?v=201',
  './js/recording-cache.js?v=201',
  './js/recorder.js?v=201',
  './js/practice-links.js?v=201',
  './js/jam-session.js?v=201',
  './js/app-shell.js?v=201',
  './vendor/soundtouch/soundtouch-processor.js?v=201',
  './icons/icon-192.png',
  './icons/icon-512.png',
