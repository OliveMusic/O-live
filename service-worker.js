importScripts('./app-version.js?v=285');
...
const ASSETS = [
  ...
  './info.css?v=285',
  './manifest.json',
  './app-version.js?v=285',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=285',
  './js/audio-runtime.js?v=285',
  './js/core.js?v=285',
  './js/metronome.js?v=285',
  './js/tuner-engine.js?v=285',
  './js/tuner.js?v=285',
  './js/scales.js?v=285',
  './js/ear-trainer.js?v=285',
  './js/rhythm-trainer.js?v=285',
  './js/recording-cache.js?v=285',
  './js/recorder.js?v=285',
  './js/practice-links.js?v=285',
  './js/jam-session.js?v=285',
  './js/practice-log.js?v=285',
  './js/app-shell.js?v=285',
  './vendor/soundtouch/soundtouch-processor.js?v=285',
  './icons/icon-192.png',
  './icons/icon-512.png',
