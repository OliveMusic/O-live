importScripts('./app-version.js?v=260');
...
const ASSETS = [
  ...
  './info.css?v=260',
  './manifest.json',
  './app-version.js?v=260',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=260',
  './js/audio-runtime.js?v=260',
  './js/core.js?v=260',
  './js/metronome.js?v=260',
  './js/tuner-engine.js?v=260',
  './js/tuner.js?v=260',
  './js/scales.js?v=260',
  './js/ear-trainer.js?v=260',
  './js/rhythm-trainer.js?v=260',
  './js/recording-cache.js?v=260',
  './js/recorder.js?v=260',
  './js/practice-links.js?v=260',
  './js/jam-session.js?v=260',
  './js/practice-log.js?v=260',
  './js/app-shell.js?v=260',
  './vendor/soundtouch/soundtouch-processor.js?v=260',
  './icons/icon-192.png',
  './icons/icon-512.png',
