importScripts('./app-version.js?v=222');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=222',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=222',
  './js/audio-runtime.js?v=222',
  './js/core.js?v=222',
  './js/metronome.js?v=222',
  './js/tuner-engine.js?v=222',
  './js/tuner.js?v=222',
  './js/scales.js?v=222',
  './js/ear-trainer.js?v=222',
  './js/rhythm-trainer.js?v=222',
  './js/recording-cache.js?v=222',
  './js/recorder.js?v=222',
  './js/practice-links.js?v=222',
  './js/jam-session.js?v=222',
  './js/app-shell.js?v=222',
  './vendor/soundtouch/soundtouch-processor.js?v=222',
  './icons/icon-192.png',
  './icons/icon-512.png',
