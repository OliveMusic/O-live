importScripts('./app-version.js?v=236');
...
const ASSETS = [
  ...
  './info.css?v=236',
  './manifest.json',
  './app-version.js?v=236',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=236',
  './js/audio-runtime.js?v=236',
  './js/core.js?v=236',
  './js/metronome.js?v=236',
  './js/tuner-engine.js?v=236',
  './js/tuner.js?v=236',
  './js/scales.js?v=236',
  './js/ear-trainer.js?v=236',
  './js/rhythm-trainer.js?v=236',
  './js/recording-cache.js?v=236',
  './js/recorder.js?v=236',
  './js/practice-links.js?v=236',
  './js/jam-session.js?v=236',
  './js/app-shell.js?v=236',
  './vendor/soundtouch/soundtouch-processor.js?v=236',
  './icons/icon-192.png',
  './icons/icon-512.png',
