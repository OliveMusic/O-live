importScripts('./app-version.js?v=286');
...
const ASSETS = [
  ...
  './info.css?v=286',
  './manifest.json',
  './app-version.js?v=286',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=286',
  './js/audio-runtime.js?v=286',
  './js/core.js?v=286',
  './js/metronome.js?v=286',
  './js/tuner-engine.js?v=286',
  './js/tuner.js?v=286',
  './js/scales.js?v=286',
  './js/ear-trainer.js?v=286',
  './js/rhythm-trainer.js?v=286',
  './js/recording-cache.js?v=286',
  './js/recorder.js?v=286',
  './js/practice-links.js?v=286',
  './js/jam-session.js?v=286',
  './js/practice-log.js?v=286',
  './js/app-shell.js?v=286',
  './vendor/soundtouch/soundtouch-processor.js?v=286',
  './icons/icon-192.png',
  './icons/icon-512.png',
