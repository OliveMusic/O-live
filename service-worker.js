importScripts('./app-version.js?v=190');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=190',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=190',
  './js/audio-runtime.js?v=190',
  './js/core.js?v=190',
  './js/metronome.js?v=190',
  './js/tuner-engine.js?v=190',
  './js/tuner.js?v=190',
  './js/scales.js?v=190',
  './js/ear-trainer.js?v=190',
  './js/rhythm-trainer.js?v=190',
  './js/recording-cache.js?v=190',
  './js/recorder.js?v=190',
  './js/practice-links.js?v=190',
  './js/jam-session.js?v=190',
  './js/app-shell.js?v=190',
  './vendor/soundtouch/soundtouch-processor.js?v=190',
  './icons/icon-192.png',
  './icons/icon-512.png',
