importScripts('./app-version.js?v=187');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=187',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=187',
  './js/audio-runtime.js?v=187',
  './js/core.js?v=187',
  './js/metronome.js?v=187',
  './js/tuner-engine.js?v=187',
  './js/tuner.js?v=187',
  './js/scales.js?v=187',
  './js/ear-trainer.js?v=187',
  './js/rhythm-trainer.js?v=187',
  './js/recording-cache.js?v=187',
  './js/recorder.js?v=187',
  './js/practice-links.js?v=187',
  './js/jam-session.js?v=187',
  './js/app-shell.js?v=187',
  './vendor/soundtouch/soundtouch-processor.js?v=187',
  './icons/icon-192.png',
  './icons/icon-512.png',
