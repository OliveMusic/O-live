importScripts('./app-version.js?v=226');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=226',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=226',
  './js/audio-runtime.js?v=226',
  './js/core.js?v=226',
  './js/metronome.js?v=226',
  './js/tuner-engine.js?v=226',
  './js/tuner.js?v=226',
  './js/scales.js?v=226',
  './js/ear-trainer.js?v=226',
  './js/rhythm-trainer.js?v=226',
  './js/recording-cache.js?v=226',
  './js/recorder.js?v=226',
  './js/practice-links.js?v=226',
  './js/jam-session.js?v=226',
  './js/app-shell.js?v=226',
  './vendor/soundtouch/soundtouch-processor.js?v=226',
  './icons/icon-192.png',
  './icons/icon-512.png',
