importScripts('./app-version.js?v=229');
...
const ASSETS = [
  ...
  './info.css?v=229',
  './manifest.json',
  './app-version.js?v=229',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=229',
  './js/audio-runtime.js?v=229',
  './js/core.js?v=229',
  './js/metronome.js?v=229',
  './js/tuner-engine.js?v=229',
  './js/tuner.js?v=229',
  './js/scales.js?v=229',
  './js/ear-trainer.js?v=229',
  './js/rhythm-trainer.js?v=229',
  './js/recording-cache.js?v=229',
  './js/recorder.js?v=229',
  './js/practice-links.js?v=229',
  './js/jam-session.js?v=229',
  './js/app-shell.js?v=229',
  './vendor/soundtouch/soundtouch-processor.js?v=229',
  './icons/icon-192.png',
  './icons/icon-512.png',
