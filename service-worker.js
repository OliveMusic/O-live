importScripts('./app-version.js?v=204');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=204',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=204',
  './js/audio-runtime.js?v=204',
  './js/core.js?v=204',
  './js/metronome.js?v=204',
  './js/tuner-engine.js?v=204',
  './js/tuner.js?v=204',
  './js/scales.js?v=204',
  './js/ear-trainer.js?v=204',
  './js/rhythm-trainer.js?v=204',
  './js/recording-cache.js?v=204',
  './js/recorder.js?v=204',
  './js/practice-links.js?v=204',
  './js/jam-session.js?v=204',
  './js/app-shell.js?v=204',
  './vendor/soundtouch/soundtouch-processor.js?v=204',
  './icons/icon-192.png',
  './icons/icon-512.png',
