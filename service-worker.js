importScripts('./app-version.js?v=181');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=181',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=181',
  './js/audio-runtime.js?v=181',
  './js/core.js?v=181',
  './js/metronome.js?v=181',
  './js/tuner-engine.js?v=181',
  './js/tuner.js?v=181',
  './js/scales.js?v=181',
  './js/ear-trainer.js?v=181',
  './js/rhythm-trainer.js?v=181',
  './js/recording-cache.js?v=181',
  './js/recorder.js?v=181',
  './js/practice-links.js?v=181',
  './js/jam-session.js?v=181',
  './js/app-shell.js?v=181',
  './vendor/soundtouch/soundtouch-processor.js?v=181',
  './icons/icon-192.png',
  './icons/icon-512.png',
