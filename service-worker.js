importScripts('./app-version.js?v=183');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=183',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=183',
  './js/audio-runtime.js?v=183',
  './js/core.js?v=183',
  './js/metronome.js?v=183',
  './js/tuner-engine.js?v=183',
  './js/tuner.js?v=183',
  './js/scales.js?v=183',
  './js/ear-trainer.js?v=183',
  './js/rhythm-trainer.js?v=183',
  './js/recording-cache.js?v=183',
  './js/recorder.js?v=183',
  './js/practice-links.js?v=183',
  './js/jam-session.js?v=183',
  './js/app-shell.js?v=183',
  './vendor/soundtouch/soundtouch-processor.js?v=183',
  './icons/icon-192.png',
  './icons/icon-512.png',
