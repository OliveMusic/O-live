importScripts('./app-version.js?v=288');
...
const ASSETS = [
  ...
  './info.css?v=288',
  './manifest.json',
  './app-version.js?v=288',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=288',
  './js/audio-runtime.js?v=288',
  './js/core.js?v=288',
  './js/metronome.js?v=288',
  './js/tuner-engine.js?v=288',
  './js/tuner.js?v=288',
  './js/scales.js?v=288',
  './js/ear-trainer.js?v=288',
  './js/rhythm-trainer.js?v=288',
  './js/recording-cache.js?v=288',
  './js/recorder.js?v=288',
  './js/practice-links.js?v=288',
  './js/jam-session.js?v=288',
  './js/practice-log.js?v=288',
  './js/app-shell.js?v=288',
  './vendor/soundtouch/soundtouch-processor.js?v=288',
  './icons/icon-192.png',
  './icons/icon-512.png',
