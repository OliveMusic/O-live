importScripts('./app-version.js?v=193');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=193',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=193',
  './js/audio-runtime.js?v=193',
  './js/core.js?v=193',
  './js/metronome.js?v=193',
  './js/tuner-engine.js?v=193',
  './js/tuner.js?v=193',
  './js/scales.js?v=193',
  './js/ear-trainer.js?v=193',
  './js/rhythm-trainer.js?v=193',
  './js/recording-cache.js?v=193',
  './js/recorder.js?v=193',
  './js/practice-links.js?v=193',
  './js/jam-session.js?v=193',
  './js/app-shell.js?v=193',
  './vendor/soundtouch/soundtouch-processor.js?v=193',
  './icons/icon-192.png',
  './icons/icon-512.png',
