importScripts('./app-version.js?v=255');
...
const ASSETS = [
  ...
  './info.css?v=255',
  './manifest.json',
  './app-version.js?v=255',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=255',
  './js/audio-runtime.js?v=255',
  './js/core.js?v=255',
  './js/metronome.js?v=255',
  './js/tuner-engine.js?v=255',
  './js/tuner.js?v=255',
  './js/scales.js?v=255',
  './js/ear-trainer.js?v=255',
  './js/rhythm-trainer.js?v=255',
  './js/recording-cache.js?v=255',
  './js/recorder.js?v=255',
  './js/practice-links.js?v=255',
  './js/jam-session.js?v=255',
  './js/practice-log.js?v=255',
  './js/app-shell.js?v=255',
  './vendor/soundtouch/soundtouch-processor.js?v=255',
  './icons/icon-192.png',
  './icons/icon-512.png',
