importScripts('./app-version.js?v=238');
...
const ASSETS = [
  ...
  './info.css?v=238',
  './manifest.json',
  './app-version.js?v=238',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=238',
  './js/audio-runtime.js?v=238',
  './js/core.js?v=238',
  './js/metronome.js?v=238',
  './js/tuner-engine.js?v=238',
  './js/tuner.js?v=238',
  './js/scales.js?v=238',
  './js/ear-trainer.js?v=238',
  './js/rhythm-trainer.js?v=238',
  './js/recording-cache.js?v=238',
  './js/recorder.js?v=238',
  './js/practice-links.js?v=238',
  './js/jam-session.js?v=238',
  './js/practice-log.js?v=238',
  './js/app-shell.js?v=238',
  './vendor/soundtouch/soundtouch-processor.js?v=238',
  './icons/icon-192.png',
  './icons/icon-512.png',
