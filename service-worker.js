importScripts('./app-version.js?v=268');
...
const ASSETS = [
  ...
  './info.css?v=268',
  './manifest.json',
  './app-version.js?v=268',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=268',
  './js/audio-runtime.js?v=268',
  './js/core.js?v=268',
  './js/metronome.js?v=268',
  './js/tuner-engine.js?v=268',
  './js/tuner.js?v=268',
  './js/scales.js?v=268',
  './js/ear-trainer.js?v=268',
  './js/rhythm-trainer.js?v=268',
  './js/recording-cache.js?v=268',
  './js/recorder.js?v=268',
  './js/practice-links.js?v=268',
  './js/jam-session.js?v=268',
  './js/practice-log.js?v=268',
  './js/app-shell.js?v=268',
  './vendor/soundtouch/soundtouch-processor.js?v=268',
  './icons/icon-192.png',
  './icons/icon-512.png',
