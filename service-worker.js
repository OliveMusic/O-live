importScripts('./app-version.js?v=225');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=225',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=225',
  './js/audio-runtime.js?v=225',
  './js/core.js?v=225',
  './js/metronome.js?v=225',
  './js/tuner-engine.js?v=225',
  './js/tuner.js?v=225',
  './js/scales.js?v=225',
  './js/ear-trainer.js?v=225',
  './js/rhythm-trainer.js?v=225',
  './js/recording-cache.js?v=225',
  './js/recorder.js?v=225',
  './js/practice-links.js?v=225',
  './js/jam-session.js?v=225',
  './js/app-shell.js?v=225',
  './vendor/soundtouch/soundtouch-processor.js?v=225',
  './icons/icon-192.png',
  './icons/icon-512.png',
