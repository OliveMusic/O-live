importScripts('./app-version.js?v=174');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=174',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=174',
  './js/audio-runtime.js?v=174',
  './js/core.js?v=174',
  './js/metronome.js?v=174',
  './js/tuner-engine.js?v=174',
  './js/tuner.js?v=174',
  './js/scales.js?v=174',
  './js/ear-trainer.js?v=174',
  './js/rhythm-trainer.js?v=174',
  './js/recording-cache.js?v=174',
  './js/recorder.js?v=174',
  './js/jam-session.js?v=174',
  './js/app-shell.js?v=174',
  './vendor/soundtouch/soundtouch-processor.js?v=174',
  './icons/icon-192.png',
  './icons/icon-512.png',
