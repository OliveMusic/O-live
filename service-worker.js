importScripts('./app-version.js?v=188');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=188',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=188',
  './js/audio-runtime.js?v=188',
  './js/core.js?v=188',
  './js/metronome.js?v=188',
  './js/tuner-engine.js?v=188',
  './js/tuner.js?v=188',
  './js/scales.js?v=188',
  './js/ear-trainer.js?v=188',
  './js/rhythm-trainer.js?v=188',
  './js/recording-cache.js?v=188',
  './js/recorder.js?v=188',
  './js/practice-links.js?v=188',
  './js/jam-session.js?v=188',
  './js/app-shell.js?v=188',
  './vendor/soundtouch/soundtouch-processor.js?v=188',
  './icons/icon-192.png',
  './icons/icon-512.png',
