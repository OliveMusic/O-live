importScripts('./app-version.js?v=205');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=205',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=205',
  './js/audio-runtime.js?v=205',
  './js/core.js?v=205',
  './js/metronome.js?v=205',
  './js/tuner-engine.js?v=205',
  './js/tuner.js?v=205',
  './js/scales.js?v=205',
  './js/ear-trainer.js?v=205',
  './js/rhythm-trainer.js?v=205',
  './js/recording-cache.js?v=205',
  './js/recorder.js?v=205',
  './js/practice-links.js?v=205',
  './js/jam-session.js?v=205',
  './js/app-shell.js?v=205',
  './vendor/soundtouch/soundtouch-processor.js?v=205',
  './icons/icon-192.png',
  './icons/icon-512.png',
