importScripts('./app-version.js?v=202');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=202',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=202',
  './js/audio-runtime.js?v=202',
  './js/core.js?v=202',
  './js/metronome.js?v=202',
  './js/tuner-engine.js?v=202',
  './js/tuner.js?v=202',
  './js/scales.js?v=202',
  './js/ear-trainer.js?v=202',
  './js/rhythm-trainer.js?v=202',
  './js/recording-cache.js?v=202',
  './js/recorder.js?v=202',
  './js/practice-links.js?v=202',
  './js/jam-session.js?v=202',
  './js/app-shell.js?v=202',
  './vendor/soundtouch/soundtouch-processor.js?v=202',
  './icons/icon-192.png',
  './icons/icon-512.png',
