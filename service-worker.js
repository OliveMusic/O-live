importScripts('./app-version.js?v=252');
...
const ASSETS = [
  ...
  './info.css?v=252',
  './manifest.json',
  './app-version.js?v=252',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=252',
  './js/audio-runtime.js?v=252',
  './js/core.js?v=252',
  './js/metronome.js?v=252',
  './js/tuner-engine.js?v=252',
  './js/tuner.js?v=252',
  './js/scales.js?v=252',
  './js/ear-trainer.js?v=252',
  './js/rhythm-trainer.js?v=252',
  './js/recording-cache.js?v=252',
  './js/recorder.js?v=252',
  './js/practice-links.js?v=252',
  './js/jam-session.js?v=252',
  './js/practice-log.js?v=252',
  './js/app-shell.js?v=252',
  './vendor/soundtouch/soundtouch-processor.js?v=252',
  './icons/icon-192.png',
  './icons/icon-512.png',
