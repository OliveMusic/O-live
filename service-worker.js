importScripts('./app-version.js?v=185');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=185',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=185',
  './js/audio-runtime.js?v=185',
  './js/core.js?v=185',
  './js/metronome.js?v=185',
  './js/tuner-engine.js?v=185',
  './js/tuner.js?v=185',
  './js/scales.js?v=185',
  './js/ear-trainer.js?v=185',
  './js/rhythm-trainer.js?v=185',
  './js/recording-cache.js?v=185',
  './js/recorder.js?v=185',
  './js/practice-links.js?v=185',
  './js/jam-session.js?v=185',
  './js/app-shell.js?v=185',
  './vendor/soundtouch/soundtouch-processor.js?v=185',
  './icons/icon-192.png',
  './icons/icon-512.png',
