importScripts('./app-version.js?v=305');
...
const ASSETS = [
  ...
  './info.css?v=305',
  './manifest.json',
  './app-version.js?v=305',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=305',
  './js/audio-runtime.js?v=305',
  './js/core.js?v=305',
  './js/metronome.js?v=305',
  './js/tuner-engine.js?v=305',
  './js/tuner.js?v=305',
  './js/scales.js?v=305',
  './js/ear-trainer.js?v=305',
  './js/rhythm-trainer.js?v=305',
  './js/recording-cache.js?v=305',
  './js/recorder.js?v=305',
  './js/practice-links.js?v=305',
  './js/jam-session.js?v=305',
  './js/practice-log.js?v=305',
  './js/app-shell.js?v=305',
  './vendor/soundtouch/soundtouch-processor.js?v=305',
  './icons/icon-192.png',
  './icons/icon-512.png',
