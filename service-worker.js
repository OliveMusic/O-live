importScripts('./app-version.js?v=248');
...
const ASSETS = [
  ...
  './info.css?v=248',
  './manifest.json',
  './app-version.js?v=248',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=248',
  './js/audio-runtime.js?v=248',
  './js/core.js?v=248',
  './js/metronome.js?v=248',
  './js/tuner-engine.js?v=248',
  './js/tuner.js?v=248',
  './js/scales.js?v=248',
  './js/ear-trainer.js?v=248',
  './js/rhythm-trainer.js?v=248',
  './js/recording-cache.js?v=248',
  './js/recorder.js?v=248',
  './js/practice-links.js?v=248',
  './js/jam-session.js?v=248',
  './js/practice-log.js?v=248',
  './js/app-shell.js?v=248',
  './vendor/soundtouch/soundtouch-processor.js?v=248',
  './icons/icon-192.png',
  './icons/icon-512.png',
