importScripts('./app-version.js?v=279');
...
const ASSETS = [
  ...
  './info.css?v=279',
  './manifest.json',
  './app-version.js?v=279',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=279',
  './js/audio-runtime.js?v=279',
  './js/core.js?v=279',
  './js/metronome.js?v=279',
  './js/tuner-engine.js?v=279',
  './js/tuner.js?v=279',
  './js/scales.js?v=279',
  './js/ear-trainer.js?v=279',
  './js/rhythm-trainer.js?v=279',
  './js/recording-cache.js?v=279',
  './js/recorder.js?v=279',
  './js/practice-links.js?v=279',
  './js/jam-session.js?v=279',
  './js/practice-log.js?v=279',
  './js/app-shell.js?v=279',
  './vendor/soundtouch/soundtouch-processor.js?v=279',
  './icons/icon-192.png',
  './icons/icon-512.png',
