importScripts('./app-version.js?v=178');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=178',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=178',
  './js/audio-runtime.js?v=178',
  './js/core.js?v=178',
  './js/metronome.js?v=178',
  './js/tuner-engine.js?v=178',
  './js/tuner.js?v=178',
  './js/scales.js?v=178',
  './js/ear-trainer.js?v=178',
  './js/rhythm-trainer.js?v=178',
  './js/recording-cache.js?v=178',
  './js/recorder.js?v=178',
  './js/jam-session.js?v=178',
  './js/app-shell.js?v=178',
  './vendor/soundtouch/soundtouch-processor.js?v=178',
  './icons/icon-192.png',
  './icons/icon-512.png',
