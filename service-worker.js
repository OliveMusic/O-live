importScripts('./app-version.js?v=169');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=169',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=169',
  './js/audio-runtime.js?v=169',
  './js/core.js?v=169',
  './js/metronome.js?v=169',
  './js/tuner-engine.js?v=169',
  './js/tuner.js?v=169',
  './js/scales.js?v=169',
  './js/ear-trainer.js?v=169',
  './js/rhythm-trainer.js?v=169',
  './js/recording-cache.js?v=169',
  './js/recorder.js?v=169',
  './js/jam-session.js?v=169',
  './js/app-shell.js?v=169',
  './vendor/soundtouch/soundtouch-processor.js?v=169',
  './icons/icon-192.png',
  './icons/icon-512.png',
