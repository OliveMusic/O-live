importScripts('./app-version.js?v=290');
...
const ASSETS = [
  ...
  './info.css?v=290',
  './manifest.json',
  './app-version.js?v=290',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=290',
  './js/audio-runtime.js?v=290',
  './js/core.js?v=290',
  './js/metronome.js?v=290',
  './js/tuner-engine.js?v=290',
  './js/tuner.js?v=290',
  './js/scales.js?v=290',
  './js/ear-trainer.js?v=290',
  './js/rhythm-trainer.js?v=290',
  './js/recording-cache.js?v=290',
  './js/recorder.js?v=290',
  './js/practice-links.js?v=290',
  './js/jam-session.js?v=290',
  './js/practice-log.js?v=290',
  './js/app-shell.js?v=290',
  './vendor/soundtouch/soundtouch-processor.js?v=290',
  './icons/icon-192.png',
  './icons/icon-512.png',
