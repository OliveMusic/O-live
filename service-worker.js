importScripts('./app-version.js?v=175');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=175',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=175',
  './js/audio-runtime.js?v=175',
  './js/core.js?v=175',
  './js/metronome.js?v=175',
  './js/tuner-engine.js?v=175',
  './js/tuner.js?v=175',
  './js/scales.js?v=175',
  './js/ear-trainer.js?v=175',
  './js/rhythm-trainer.js?v=175',
  './js/recording-cache.js?v=175',
  './js/recorder.js?v=175',
  './js/jam-session.js?v=175',
  './js/app-shell.js?v=175',
  './vendor/soundtouch/soundtouch-processor.js?v=175',
  './icons/icon-192.png',
  './icons/icon-512.png',
