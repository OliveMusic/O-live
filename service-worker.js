importScripts('./app-version.js?v=168');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=168',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=168',
  './js/audio-runtime.js?v=168',
  './js/core.js?v=168',
  './js/metronome.js?v=168',
  './js/tuner-engine.js?v=168',
  './js/tuner.js?v=168',
  './js/scales.js?v=168',
  './js/ear-trainer.js?v=168',
  './js/rhythm-trainer.js?v=168',
  './js/recording-cache.js?v=168',
  './js/recorder.js?v=168',
  './js/jam-session.js?v=168',
  './js/app-shell.js?v=168',
  './vendor/soundtouch/soundtouch-processor.js?v=168',
  './icons/icon-192.png',
  './icons/icon-512.png',
