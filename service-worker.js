importScripts('./app-version.js?v=297');
...
const ASSETS = [
  ...
  './info.css?v=297',
  './manifest.json',
  './app-version.js?v=297',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=297',
  './js/audio-runtime.js?v=297',
  './js/core.js?v=297',
  './js/metronome.js?v=297',
  './js/tuner-engine.js?v=297',
  './js/tuner.js?v=297',
  './js/scales.js?v=297',
  './js/ear-trainer.js?v=297',
  './js/rhythm-trainer.js?v=297',
  './js/recording-cache.js?v=297',
  './js/recorder.js?v=297',
  './js/practice-links.js?v=297',
  './js/jam-session.js?v=297',
  './js/practice-log.js?v=297',
  './js/app-shell.js?v=297',
  './vendor/soundtouch/soundtouch-processor.js?v=297',
  './icons/icon-192.png',
  './icons/icon-512.png',
