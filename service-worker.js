importScripts('./app-version.js?v=295');
...
const ASSETS = [
  ...
  './info.css?v=295',
  './manifest.json',
  './app-version.js?v=295',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=295',
  './js/audio-runtime.js?v=295',
  './js/core.js?v=295',
  './js/metronome.js?v=295',
  './js/tuner-engine.js?v=295',
  './js/tuner.js?v=295',
  './js/scales.js?v=295',
  './js/ear-trainer.js?v=295',
  './js/rhythm-trainer.js?v=295',
  './js/recording-cache.js?v=295',
  './js/recorder.js?v=295',
  './js/practice-links.js?v=295',
  './js/jam-session.js?v=295',
  './js/practice-log.js?v=295',
  './js/app-shell.js?v=295',
  './vendor/soundtouch/soundtouch-processor.js?v=295',
  './icons/icon-192.png',
  './icons/icon-512.png',
