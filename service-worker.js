importScripts('./app-version.js?v=180');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=180',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=180',
  './js/audio-runtime.js?v=180',
  './js/core.js?v=180',
  './js/metronome.js?v=180',
  './js/tuner-engine.js?v=180',
  './js/tuner.js?v=180',
  './js/scales.js?v=180',
  './js/ear-trainer.js?v=180',
  './js/rhythm-trainer.js?v=180',
  './js/recording-cache.js?v=180',
  './js/recorder.js?v=180',
  './js/practice-links.js?v=180',
  './js/jam-session.js?v=180',
  './js/app-shell.js?v=180',
  './vendor/soundtouch/soundtouch-processor.js?v=180',
  './icons/icon-192.png',
  './icons/icon-512.png',
