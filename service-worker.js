importScripts('./app-version.js?v=308');
...
const ASSETS = [
  ...
  './info.css?v=308',
  './manifest.json',
  './app-version.js?v=308',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=308',
  './js/audio-runtime.js?v=308',
  './js/core.js?v=308',
  './js/metronome.js?v=308',
  './js/tuner-engine.js?v=308',
  './js/tuner.js?v=308',
  './js/scales.js?v=308',
  './js/ear-trainer.js?v=308',
  './js/rhythm-trainer.js?v=308',
  './js/recording-cache.js?v=308',
  './js/recorder.js?v=308',
  './js/practice-links.js?v=308',
  './js/jam-session.js?v=308',
  './js/practice-log.js?v=308',
  './js/app-shell.js?v=308',
  './vendor/soundtouch/soundtouch-processor.js?v=308',
  './icons/icon-192.png',
  './icons/icon-512.png',
