importScripts('./app-version.js?v=195');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=195',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=195',
  './js/audio-runtime.js?v=195',
  './js/core.js?v=195',
  './js/metronome.js?v=195',
  './js/tuner-engine.js?v=195',
  './js/tuner.js?v=195',
  './js/scales.js?v=195',
  './js/ear-trainer.js?v=195',
  './js/rhythm-trainer.js?v=195',
  './js/recording-cache.js?v=195',
  './js/recorder.js?v=195',
  './js/practice-links.js?v=195',
  './js/jam-session.js?v=195',
  './js/app-shell.js?v=195',
  './vendor/soundtouch/soundtouch-processor.js?v=195',
  './icons/icon-192.png',
  './icons/icon-512.png',
