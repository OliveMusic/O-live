importScripts('./app-version.js?v=258');
...
const ASSETS = [
  ...
  './info.css?v=258',
  './manifest.json',
  './app-version.js?v=258',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=258',
  './js/audio-runtime.js?v=258',
  './js/core.js?v=258',
  './js/metronome.js?v=258',
  './js/tuner-engine.js?v=258',
  './js/tuner.js?v=258',
  './js/scales.js?v=258',
  './js/ear-trainer.js?v=258',
  './js/rhythm-trainer.js?v=258',
  './js/recording-cache.js?v=258',
  './js/recorder.js?v=258',
  './js/practice-links.js?v=258',
  './js/jam-session.js?v=258',
  './js/practice-log.js?v=258',
  './js/app-shell.js?v=258',
  './vendor/soundtouch/soundtouch-processor.js?v=258',
  './icons/icon-192.png',
  './icons/icon-512.png',
