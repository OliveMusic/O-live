importScripts('./app-version.js?v=207');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=207',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=207',
  './js/audio-runtime.js?v=207',
  './js/core.js?v=207',
  './js/metronome.js?v=207',
  './js/tuner-engine.js?v=207',
  './js/tuner.js?v=207',
  './js/scales.js?v=207',
  './js/ear-trainer.js?v=207',
  './js/rhythm-trainer.js?v=207',
  './js/recording-cache.js?v=207',
  './js/recorder.js?v=207',
  './js/practice-links.js?v=207',
  './js/jam-session.js?v=207',
  './js/app-shell.js?v=207',
  './vendor/soundtouch/soundtouch-processor.js?v=207',
  './icons/icon-192.png',
  './icons/icon-512.png',
