importScripts('./app-version.js?v=282');
...
const ASSETS = [
  ...
  './info.css?v=282',
  './manifest.json',
  './app-version.js?v=282',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=282',
  './js/audio-runtime.js?v=282',
  './js/core.js?v=282',
  './js/metronome.js?v=282',
  './js/tuner-engine.js?v=282',
  './js/tuner.js?v=282',
  './js/scales.js?v=282',
  './js/ear-trainer.js?v=282',
  './js/rhythm-trainer.js?v=282',
  './js/recording-cache.js?v=282',
  './js/recorder.js?v=282',
  './js/practice-links.js?v=282',
  './js/jam-session.js?v=282',
  './js/practice-log.js?v=282',
  './js/app-shell.js?v=282',
  './vendor/soundtouch/soundtouch-processor.js?v=282',
  './icons/icon-192.png',
  './icons/icon-512.png',
