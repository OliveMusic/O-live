importScripts('./app-version.js?v=171');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=171',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=171',
  './js/audio-runtime.js?v=171',
  './js/core.js?v=171',
  './js/metronome.js?v=171',
  './js/tuner-engine.js?v=171',
  './js/tuner.js?v=171',
  './js/scales.js?v=171',
  './js/ear-trainer.js?v=171',
  './js/rhythm-trainer.js?v=171',
  './js/recording-cache.js?v=171',
  './js/recorder.js?v=171',
  './js/jam-session.js?v=171',
  './js/app-shell.js?v=171',
  './vendor/soundtouch/soundtouch-processor.js?v=171',
  './icons/icon-192.png',
  './icons/icon-512.png',
