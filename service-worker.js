importScripts('./app-version.js?v=209');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=209',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=209',
  './js/audio-runtime.js?v=209',
  './js/core.js?v=209',
  './js/metronome.js?v=209',
  './js/tuner-engine.js?v=209',
  './js/tuner.js?v=209',
  './js/scales.js?v=209',
  './js/ear-trainer.js?v=209',
  './js/rhythm-trainer.js?v=209',
  './js/recording-cache.js?v=209',
  './js/recorder.js?v=209',
  './js/practice-links.js?v=209',
  './js/jam-session.js?v=209',
  './js/app-shell.js?v=209',
  './vendor/soundtouch/soundtouch-processor.js?v=209',
  './icons/icon-192.png',
  './icons/icon-512.png',
