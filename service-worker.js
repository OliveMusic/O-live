importScripts('./app-version.js?v=227');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=227',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=227',
  './js/audio-runtime.js?v=227',
  './js/core.js?v=227',
  './js/metronome.js?v=227',
  './js/tuner-engine.js?v=227',
  './js/tuner.js?v=227',
  './js/scales.js?v=227',
  './js/ear-trainer.js?v=227',
  './js/rhythm-trainer.js?v=227',
  './js/recording-cache.js?v=227',
  './js/recorder.js?v=227',
  './js/practice-links.js?v=227',
  './js/jam-session.js?v=227',
  './js/app-shell.js?v=227',
  './vendor/soundtouch/soundtouch-processor.js?v=227',
  './icons/icon-192.png',
  './icons/icon-512.png',
