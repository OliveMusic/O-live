importScripts('./app-version.js?v=214');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=214',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=214',
  './js/audio-runtime.js?v=214',
  './js/core.js?v=214',
  './js/metronome.js?v=214',
  './js/tuner-engine.js?v=214',
  './js/tuner.js?v=214',
  './js/scales.js?v=214',
  './js/ear-trainer.js?v=214',
  './js/rhythm-trainer.js?v=214',
  './js/recording-cache.js?v=214',
  './js/recorder.js?v=214',
  './js/practice-links.js?v=214',
  './js/jam-session.js?v=214',
  './js/app-shell.js?v=214',
  './vendor/soundtouch/soundtouch-processor.js?v=214',
  './icons/icon-192.png',
  './icons/icon-512.png',
