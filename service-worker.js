importScripts('./app-version.js?v=216');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=216',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=216',
  './js/audio-runtime.js?v=216',
  './js/core.js?v=216',
  './js/metronome.js?v=216',
  './js/tuner-engine.js?v=216',
  './js/tuner.js?v=216',
  './js/scales.js?v=216',
  './js/ear-trainer.js?v=216',
  './js/rhythm-trainer.js?v=216',
  './js/recording-cache.js?v=216',
  './js/recorder.js?v=216',
  './js/practice-links.js?v=216',
  './js/jam-session.js?v=216',
  './js/app-shell.js?v=216',
  './vendor/soundtouch/soundtouch-processor.js?v=216',
  './icons/icon-192.png',
  './icons/icon-512.png',
