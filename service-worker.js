importScripts('./app-version.js?v=220');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=220',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=220',
  './js/audio-runtime.js?v=220',
  './js/core.js?v=220',
  './js/metronome.js?v=220',
  './js/tuner-engine.js?v=220',
  './js/tuner.js?v=220',
  './js/scales.js?v=220',
  './js/ear-trainer.js?v=220',
  './js/rhythm-trainer.js?v=220',
  './js/recording-cache.js?v=220',
  './js/recorder.js?v=220',
  './js/practice-links.js?v=220',
  './js/jam-session.js?v=220',
  './js/app-shell.js?v=220',
  './vendor/soundtouch/soundtouch-processor.js?v=220',
  './icons/icon-192.png',
  './icons/icon-512.png',
