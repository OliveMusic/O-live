importScripts('./app-version.js?v=241');
...
const ASSETS = [
  ...
  './info.css?v=241',
  './manifest.json',
  './app-version.js?v=241',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=241',
  './js/audio-runtime.js?v=241',
  './js/core.js?v=241',
  './js/metronome.js?v=241',
  './js/tuner-engine.js?v=241',
  './js/tuner.js?v=241',
  './js/scales.js?v=241',
  './js/ear-trainer.js?v=241',
  './js/rhythm-trainer.js?v=241',
  './js/recording-cache.js?v=241',
  './js/recorder.js?v=241',
  './js/practice-links.js?v=241',
  './js/jam-session.js?v=241',
  './js/practice-log.js?v=241',
  './js/app-shell.js?v=241',
  './vendor/soundtouch/soundtouch-processor.js?v=241',
  './icons/icon-192.png',
  './icons/icon-512.png',
