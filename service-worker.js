importScripts('./app-version.js?v=210');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=210',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=210',
  './js/audio-runtime.js?v=210',
  './js/core.js?v=210',
  './js/metronome.js?v=210',
  './js/tuner-engine.js?v=210',
  './js/tuner.js?v=210',
  './js/scales.js?v=210',
  './js/ear-trainer.js?v=210',
  './js/rhythm-trainer.js?v=210',
  './js/recording-cache.js?v=210',
  './js/recorder.js?v=210',
  './js/practice-links.js?v=210',
  './js/jam-session.js?v=210',
  './js/app-shell.js?v=210',
  './vendor/soundtouch/soundtouch-processor.js?v=210',
  './icons/icon-192.png',
  './icons/icon-512.png',
