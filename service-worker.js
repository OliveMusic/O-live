importScripts('./app-version.js?v=264');
...
const ASSETS = [
  ...
  './info.css?v=264',
  './manifest.json',
  './app-version.js?v=264',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=264',
  './js/audio-runtime.js?v=264',
  './js/core.js?v=264',
  './js/metronome.js?v=264',
  './js/tuner-engine.js?v=264',
  './js/tuner.js?v=264',
  './js/scales.js?v=264',
  './js/ear-trainer.js?v=264',
  './js/rhythm-trainer.js?v=264',
  './js/recording-cache.js?v=264',
  './js/recorder.js?v=264',
  './js/practice-links.js?v=264',
  './js/jam-session.js?v=264',
  './js/practice-log.js?v=264',
  './js/app-shell.js?v=264',
  './vendor/soundtouch/soundtouch-processor.js?v=264',
  './icons/icon-192.png',
  './icons/icon-512.png',
