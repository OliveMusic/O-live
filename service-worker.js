importScripts('./app-version.js?v=296');
...
const ASSETS = [
  ...
  './info.css?v=296',
  './manifest.json',
  './app-version.js?v=296',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=296',
  './js/audio-runtime.js?v=296',
  './js/core.js?v=296',
  './js/metronome.js?v=296',
  './js/tuner-engine.js?v=296',
  './js/tuner.js?v=296',
  './js/scales.js?v=296',
  './js/ear-trainer.js?v=296',
  './js/rhythm-trainer.js?v=296',
  './js/recording-cache.js?v=296',
  './js/recorder.js?v=296',
  './js/practice-links.js?v=296',
  './js/jam-session.js?v=296',
  './js/practice-log.js?v=296',
  './js/app-shell.js?v=296',
  './vendor/soundtouch/soundtouch-processor.js?v=296',
  './icons/icon-192.png',
  './icons/icon-512.png',
