importScripts('./app-version.js?v=271');
...
const ASSETS = [
  ...
  './info.css?v=271',
  './manifest.json',
  './app-version.js?v=271',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=271',
  './js/audio-runtime.js?v=271',
  './js/core.js?v=271',
  './js/metronome.js?v=271',
  './js/tuner-engine.js?v=271',
  './js/tuner.js?v=271',
  './js/scales.js?v=271',
  './js/ear-trainer.js?v=271',
  './js/rhythm-trainer.js?v=271',
  './js/recording-cache.js?v=271',
  './js/recorder.js?v=271',
  './js/practice-links.js?v=271',
  './js/jam-session.js?v=271',
  './js/practice-log.js?v=271',
  './js/app-shell.js?v=271',
  './vendor/soundtouch/soundtouch-processor.js?v=271',
  './icons/icon-192.png',
  './icons/icon-512.png',
