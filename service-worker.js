importScripts('./app-version.js?v=176');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=176',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=176',
  './js/audio-runtime.js?v=176',
  './js/core.js?v=176',
  './js/metronome.js?v=176',
  './js/tuner-engine.js?v=176',
  './js/tuner.js?v=176',
  './js/scales.js?v=176',
  './js/ear-trainer.js?v=176',
  './js/rhythm-trainer.js?v=176',
  './js/recording-cache.js?v=176',
  './js/recorder.js?v=176',
  './js/jam-session.js?v=176',
  './js/app-shell.js?v=176',
  './vendor/soundtouch/soundtouch-processor.js?v=176',
  './icons/icon-192.png',
  './icons/icon-512.png',
