importScripts('./app-version.js?v=245');
...
const ASSETS = [
  ...
  './info.css?v=245',
  './manifest.json',
  './app-version.js?v=245',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=245',
  './js/audio-runtime.js?v=245',
  './js/core.js?v=245',
  './js/metronome.js?v=245',
  './js/tuner-engine.js?v=245',
  './js/tuner.js?v=245',
  './js/scales.js?v=245',
  './js/ear-trainer.js?v=245',
  './js/rhythm-trainer.js?v=245',
  './js/recording-cache.js?v=245',
  './js/recorder.js?v=245',
  './js/practice-links.js?v=245',
  './js/jam-session.js?v=245',
  './js/practice-log.js?v=245',
  './js/app-shell.js?v=245',
  './vendor/soundtouch/soundtouch-processor.js?v=245',
  './icons/icon-192.png',
  './icons/icon-512.png',
