importScripts('./app-version.js?v=223');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=223',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=223',
  './js/audio-runtime.js?v=223',
  './js/core.js?v=223',
  './js/metronome.js?v=223',
  './js/tuner-engine.js?v=223',
  './js/tuner.js?v=223',
  './js/scales.js?v=223',
  './js/ear-trainer.js?v=223',
  './js/rhythm-trainer.js?v=223',
  './js/recording-cache.js?v=223',
  './js/recorder.js?v=223',
  './js/practice-links.js?v=223',
  './js/jam-session.js?v=223',
  './js/app-shell.js?v=223',
  './vendor/soundtouch/soundtouch-processor.js?v=223',
  './icons/icon-192.png',
  './icons/icon-512.png',
