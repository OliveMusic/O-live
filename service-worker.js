importScripts('./app-version.js?v=246');
...
const ASSETS = [
  ...
  './info.css?v=246',
  './manifest.json',
  './app-version.js?v=246',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=246',
  './js/audio-runtime.js?v=246',
  './js/core.js?v=246',
  './js/metronome.js?v=246',
  './js/tuner-engine.js?v=246',
  './js/tuner.js?v=246',
  './js/scales.js?v=246',
  './js/ear-trainer.js?v=246',
  './js/rhythm-trainer.js?v=246',
  './js/recording-cache.js?v=246',
  './js/recorder.js?v=246',
  './js/practice-links.js?v=246',
  './js/jam-session.js?v=246',
  './js/practice-log.js?v=246',
  './js/app-shell.js?v=246',
  './vendor/soundtouch/soundtouch-processor.js?v=246',
  './icons/icon-192.png',
  './icons/icon-512.png',
