importScripts('./app-version.js?v=218');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=218',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=218',
  './js/audio-runtime.js?v=218',
  './js/core.js?v=218',
  './js/metronome.js?v=218',
  './js/tuner-engine.js?v=218',
  './js/tuner.js?v=218',
  './js/scales.js?v=218',
  './js/ear-trainer.js?v=218',
  './js/rhythm-trainer.js?v=218',
  './js/recording-cache.js?v=218',
  './js/recorder.js?v=218',
  './js/practice-links.js?v=218',
  './js/jam-session.js?v=218',
  './js/app-shell.js?v=218',
  './vendor/soundtouch/soundtouch-processor.js?v=218',
  './icons/icon-192.png',
  './icons/icon-512.png',
