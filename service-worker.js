importScripts('./app-version.js?v=244');
...
const ASSETS = [
  ...
  './info.css?v=244',
  './manifest.json',
  './app-version.js?v=244',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=244',
  './js/audio-runtime.js?v=244',
  './js/core.js?v=244',
  './js/metronome.js?v=244',
  './js/tuner-engine.js?v=244',
  './js/tuner.js?v=244',
  './js/scales.js?v=244',
  './js/ear-trainer.js?v=244',
  './js/rhythm-trainer.js?v=244',
  './js/recording-cache.js?v=244',
  './js/recorder.js?v=244',
  './js/practice-links.js?v=244',
  './js/jam-session.js?v=244',
  './js/practice-log.js?v=244',
  './js/app-shell.js?v=244',
  './vendor/soundtouch/soundtouch-processor.js?v=244',
  './icons/icon-192.png',
  './icons/icon-512.png',
