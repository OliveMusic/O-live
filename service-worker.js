importScripts('./app-version.js?v=284');
...
const ASSETS = [
  ...
  './info.css?v=284',
  './manifest.json',
  './app-version.js?v=284',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=284',
  './js/audio-runtime.js?v=284',
  './js/core.js?v=284',
  './js/metronome.js?v=284',
  './js/tuner-engine.js?v=284',
  './js/tuner.js?v=284',
  './js/scales.js?v=284',
  './js/ear-trainer.js?v=284',
  './js/rhythm-trainer.js?v=284',
  './js/recording-cache.js?v=284',
  './js/recorder.js?v=284',
  './js/practice-links.js?v=284',
  './js/jam-session.js?v=284',
  './js/practice-log.js?v=284',
  './js/app-shell.js?v=284',
  './vendor/soundtouch/soundtouch-processor.js?v=284',
  './icons/icon-192.png',
  './icons/icon-512.png',
