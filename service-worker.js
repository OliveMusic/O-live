importScripts('./app-version.js?v=206');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=206',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=206',
  './js/audio-runtime.js?v=206',
  './js/core.js?v=206',
  './js/metronome.js?v=206',
  './js/tuner-engine.js?v=206',
  './js/tuner.js?v=206',
  './js/scales.js?v=206',
  './js/ear-trainer.js?v=206',
  './js/rhythm-trainer.js?v=206',
  './js/recording-cache.js?v=206',
  './js/recorder.js?v=206',
  './js/practice-links.js?v=206',
  './js/jam-session.js?v=206',
  './js/app-shell.js?v=206',
  './vendor/soundtouch/soundtouch-processor.js?v=206',
  './icons/icon-192.png',
  './icons/icon-512.png',
