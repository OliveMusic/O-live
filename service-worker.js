importScripts('./app-version.js?v=189');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=189',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=189',
  './js/audio-runtime.js?v=189',
  './js/core.js?v=189',
  './js/metronome.js?v=189',
  './js/tuner-engine.js?v=189',
  './js/tuner.js?v=189',
  './js/scales.js?v=189',
  './js/ear-trainer.js?v=189',
  './js/rhythm-trainer.js?v=189',
  './js/recording-cache.js?v=189',
  './js/recorder.js?v=189',
  './js/practice-links.js?v=189',
  './js/jam-session.js?v=189',
  './js/app-shell.js?v=189',
  './vendor/soundtouch/soundtouch-processor.js?v=189',
  './icons/icon-192.png',
  './icons/icon-512.png',
