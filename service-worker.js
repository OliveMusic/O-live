importScripts('./app-version.js?v=267');
...
const ASSETS = [
  ...
  './info.css?v=267',
  './manifest.json',
  './app-version.js?v=267',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=267',
  './js/audio-runtime.js?v=267',
  './js/core.js?v=267',
  './js/metronome.js?v=267',
  './js/tuner-engine.js?v=267',
  './js/tuner.js?v=267',
  './js/scales.js?v=267',
  './js/ear-trainer.js?v=267',
  './js/rhythm-trainer.js?v=267',
  './js/recording-cache.js?v=267',
  './js/recorder.js?v=267',
  './js/practice-links.js?v=267',
  './js/jam-session.js?v=267',
  './js/practice-log.js?v=267',
  './js/app-shell.js?v=267',
  './vendor/soundtouch/soundtouch-processor.js?v=267',
  './icons/icon-192.png',
  './icons/icon-512.png',
