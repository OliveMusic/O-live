importScripts('./app-version.js?v=283');
...
const ASSETS = [
  ...
  './info.css?v=283',
  './manifest.json',
  './app-version.js?v=283',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=283',
  './js/audio-runtime.js?v=283',
  './js/core.js?v=283',
  './js/metronome.js?v=283',
  './js/tuner-engine.js?v=283',
  './js/tuner.js?v=283',
  './js/scales.js?v=283',
  './js/ear-trainer.js?v=283',
  './js/rhythm-trainer.js?v=283',
  './js/recording-cache.js?v=283',
  './js/recorder.js?v=283',
  './js/practice-links.js?v=283',
  './js/jam-session.js?v=283',
  './js/practice-log.js?v=283',
  './js/app-shell.js?v=283',
  './vendor/soundtouch/soundtouch-processor.js?v=283',
  './icons/icon-192.png',
  './icons/icon-512.png',
