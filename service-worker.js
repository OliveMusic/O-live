importScripts('./app-version.js?v=221');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=221',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=221',
  './js/audio-runtime.js?v=221',
  './js/core.js?v=221',
  './js/metronome.js?v=221',
  './js/tuner-engine.js?v=221',
  './js/tuner.js?v=221',
  './js/scales.js?v=221',
  './js/ear-trainer.js?v=221',
  './js/rhythm-trainer.js?v=221',
  './js/recording-cache.js?v=221',
  './js/recorder.js?v=221',
  './js/practice-links.js?v=221',
  './js/jam-session.js?v=221',
  './js/app-shell.js?v=221',
  './vendor/soundtouch/soundtouch-processor.js?v=221',
  './icons/icon-192.png',
  './icons/icon-512.png',
