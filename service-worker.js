importScripts('./app-version.js?v=199');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=199',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=199',
  './js/audio-runtime.js?v=199',
  './js/core.js?v=199',
  './js/metronome.js?v=199',
  './js/tuner-engine.js?v=199',
  './js/tuner.js?v=199',
  './js/scales.js?v=199',
  './js/ear-trainer.js?v=199',
  './js/rhythm-trainer.js?v=199',
  './js/recording-cache.js?v=199',
  './js/recorder.js?v=199',
  './js/practice-links.js?v=199',
  './js/jam-session.js?v=199',
  './js/app-shell.js?v=199',
  './vendor/soundtouch/soundtouch-processor.js?v=199',
  './icons/icon-192.png',
  './icons/icon-512.png',
