importScripts('./app-version.js?v=312');
...
const ASSETS = [
  ...
  './info.css?v=312',
  './manifest.json',
  './app-version.js?v=312',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=312',
  './js/audio-runtime.js?v=312',
  './js/core.js?v=312',
  './js/metronome.js?v=312',
  './js/tuner-engine.js?v=312',
  './js/tuner.js?v=312',
  './js/scales.js?v=312',
  './js/ear-trainer.js?v=312',
  './js/rhythm-trainer.js?v=312',
  './js/recording-cache.js?v=312',
  './js/recorder.js?v=312',
  './js/practice-links.js?v=312',
  './js/jam-session.js?v=312',
  './js/practice-log.js?v=312',
  './js/app-shell.js?v=312',
  './vendor/soundtouch/soundtouch-processor.js?v=312',
  './icons/icon-192.png',
  './icons/icon-512.png',
