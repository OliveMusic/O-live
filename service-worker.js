importScripts('./app-version.js?v=243');
...
const ASSETS = [
  ...
  './info.css?v=243',
  './manifest.json',
  './app-version.js?v=243',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=243',
  './js/audio-runtime.js?v=243',
  './js/core.js?v=243',
  './js/metronome.js?v=243',
  './js/tuner-engine.js?v=243',
  './js/tuner.js?v=243',
  './js/scales.js?v=243',
  './js/ear-trainer.js?v=243',
  './js/rhythm-trainer.js?v=243',
  './js/recording-cache.js?v=243',
  './js/recorder.js?v=243',
  './js/practice-links.js?v=243',
  './js/jam-session.js?v=243',
  './js/practice-log.js?v=243',
  './js/app-shell.js?v=243',
  './vendor/soundtouch/soundtouch-processor.js?v=243',
  './icons/icon-192.png',
  './icons/icon-512.png',
