importScripts('./app-version.js?v=211');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=211',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=211',
  './js/audio-runtime.js?v=211',
  './js/core.js?v=211',
  './js/metronome.js?v=211',
  './js/tuner-engine.js?v=211',
  './js/tuner.js?v=211',
  './js/scales.js?v=211',
  './js/ear-trainer.js?v=211',
  './js/rhythm-trainer.js?v=211',
  './js/recording-cache.js?v=211',
  './js/recorder.js?v=211',
  './js/practice-links.js?v=211',
  './js/jam-session.js?v=211',
  './js/app-shell.js?v=211',
  './vendor/soundtouch/soundtouch-processor.js?v=211',
  './icons/icon-192.png',
  './icons/icon-512.png',
