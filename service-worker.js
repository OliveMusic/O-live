importScripts('./app-version.js?v=179');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=179',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=179',
  './js/audio-runtime.js?v=179',
  './js/core.js?v=179',
  './js/metronome.js?v=179',
  './js/tuner-engine.js?v=179',
  './js/tuner.js?v=179',
  './js/scales.js?v=179',
  './js/ear-trainer.js?v=179',
  './js/rhythm-trainer.js?v=179',
  './js/recording-cache.js?v=179',
  './js/recorder.js?v=179',
  './js/practice-links.js?v=179',
  './js/jam-session.js?v=179',
  './js/app-shell.js?v=179',
  './vendor/soundtouch/soundtouch-processor.js?v=179',
  './icons/icon-192.png',
  './icons/icon-512.png',
