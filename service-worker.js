importScripts('./app-version.js?v=191');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=191',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=191',
  './js/audio-runtime.js?v=191',
  './js/core.js?v=191',
  './js/metronome.js?v=191',
  './js/tuner-engine.js?v=191',
  './js/tuner.js?v=191',
  './js/scales.js?v=191',
  './js/ear-trainer.js?v=191',
  './js/rhythm-trainer.js?v=191',
  './js/recording-cache.js?v=191',
  './js/recorder.js?v=191',
  './js/practice-links.js?v=191',
  './js/jam-session.js?v=191',
  './js/app-shell.js?v=191',
  './vendor/soundtouch/soundtouch-processor.js?v=191',
  './icons/icon-192.png',
  './icons/icon-512.png',
