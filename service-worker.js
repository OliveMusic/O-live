importScripts('./app-version.js?v=200');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=200',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=200',
  './js/audio-runtime.js?v=200',
  './js/core.js?v=200',
  './js/metronome.js?v=200',
  './js/tuner-engine.js?v=200',
  './js/tuner.js?v=200',
  './js/scales.js?v=200',
  './js/ear-trainer.js?v=200',
  './js/rhythm-trainer.js?v=200',
  './js/recording-cache.js?v=200',
  './js/recorder.js?v=200',
  './js/practice-links.js?v=200',
  './js/jam-session.js?v=200',
  './js/app-shell.js?v=200',
  './vendor/soundtouch/soundtouch-processor.js?v=200',
  './icons/icon-192.png',
  './icons/icon-512.png',
