importScripts('./app-version.js?v=217');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=217',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=217',
  './js/audio-runtime.js?v=217',
  './js/core.js?v=217',
  './js/metronome.js?v=217',
  './js/tuner-engine.js?v=217',
  './js/tuner.js?v=217',
  './js/scales.js?v=217',
  './js/ear-trainer.js?v=217',
  './js/rhythm-trainer.js?v=217',
  './js/recording-cache.js?v=217',
  './js/recorder.js?v=217',
  './js/practice-links.js?v=217',
  './js/jam-session.js?v=217',
  './js/app-shell.js?v=217',
  './vendor/soundtouch/soundtouch-processor.js?v=217',
  './icons/icon-192.png',
  './icons/icon-512.png',
