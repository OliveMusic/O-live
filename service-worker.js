importScripts('./app-version.js?v=208');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=208',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=208',
  './js/audio-runtime.js?v=208',
  './js/core.js?v=208',
  './js/metronome.js?v=208',
  './js/tuner-engine.js?v=208',
  './js/tuner.js?v=208',
  './js/scales.js?v=208',
  './js/ear-trainer.js?v=208',
  './js/rhythm-trainer.js?v=208',
  './js/recording-cache.js?v=208',
  './js/recorder.js?v=208',
  './js/practice-links.js?v=208',
  './js/jam-session.js?v=208',
  './js/app-shell.js?v=208',
  './vendor/soundtouch/soundtouch-processor.js?v=208',
  './icons/icon-192.png',
  './icons/icon-512.png',
