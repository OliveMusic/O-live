importScripts('./app-version.js?v=287');
...
const ASSETS = [
  ...
  './info.css?v=287',
  './manifest.json',
  './app-version.js?v=287',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=287',
  './js/audio-runtime.js?v=287',
  './js/core.js?v=287',
  './js/metronome.js?v=287',
  './js/tuner-engine.js?v=287',
  './js/tuner.js?v=287',
  './js/scales.js?v=287',
  './js/ear-trainer.js?v=287',
  './js/rhythm-trainer.js?v=287',
  './js/recording-cache.js?v=287',
  './js/recorder.js?v=287',
  './js/practice-links.js?v=287',
  './js/jam-session.js?v=287',
  './js/practice-log.js?v=287',
  './js/app-shell.js?v=287',
  './vendor/soundtouch/soundtouch-processor.js?v=287',
  './icons/icon-192.png',
  './icons/icon-512.png',
