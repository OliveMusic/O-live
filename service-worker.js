importScripts('./app-version.js?v=170');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=170',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=170',
  './js/audio-runtime.js?v=170',
  './js/core.js?v=170',
  './js/metronome.js?v=170',
  './js/tuner-engine.js?v=170',
  './js/tuner.js?v=170',
  './js/scales.js?v=170',
  './js/ear-trainer.js?v=170',
  './js/rhythm-trainer.js?v=170',
  './js/recording-cache.js?v=170',
  './js/recorder.js?v=170',
  './js/jam-session.js?v=170',
  './js/app-shell.js?v=170',
  './vendor/soundtouch/soundtouch-processor.js?v=170',
  './icons/icon-192.png',
  './icons/icon-512.png',
