importScripts('./app-version.js?v=196');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=196',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=196',
  './js/audio-runtime.js?v=196',
  './js/core.js?v=196',
  './js/metronome.js?v=196',
  './js/tuner-engine.js?v=196',
  './js/tuner.js?v=196',
  './js/scales.js?v=196',
  './js/ear-trainer.js?v=196',
  './js/rhythm-trainer.js?v=196',
  './js/recording-cache.js?v=196',
  './js/recorder.js?v=196',
  './js/practice-links.js?v=196',
  './js/jam-session.js?v=196',
  './js/app-shell.js?v=196',
  './vendor/soundtouch/soundtouch-processor.js?v=196',
  './icons/icon-192.png',
  './icons/icon-512.png',
