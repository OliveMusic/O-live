importScripts('./app-version.js?v=266');
...
const ASSETS = [
  ...
  './info.css?v=266',
  './manifest.json',
  './app-version.js?v=266',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=266',
  './js/audio-runtime.js?v=266',
  './js/core.js?v=266',
  './js/metronome.js?v=266',
  './js/tuner-engine.js?v=266',
  './js/tuner.js?v=266',
  './js/scales.js?v=266',
  './js/ear-trainer.js?v=266',
  './js/rhythm-trainer.js?v=266',
  './js/recording-cache.js?v=266',
  './js/recorder.js?v=266',
  './js/practice-links.js?v=266',
  './js/jam-session.js?v=266',
  './js/practice-log.js?v=266',
  './js/app-shell.js?v=266',
  './vendor/soundtouch/soundtouch-processor.js?v=266',
  './icons/icon-192.png',
  './icons/icon-512.png',
