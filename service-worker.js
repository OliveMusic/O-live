importScripts('./app-version.js?v=228');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=228',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=228',
  './js/audio-runtime.js?v=228',
  './js/core.js?v=228',
  './js/metronome.js?v=228',
  './js/tuner-engine.js?v=228',
  './js/tuner.js?v=228',
  './js/scales.js?v=228',
  './js/ear-trainer.js?v=228',
  './js/rhythm-trainer.js?v=228',
  './js/recording-cache.js?v=228',
  './js/recorder.js?v=228',
  './js/practice-links.js?v=228',
  './js/jam-session.js?v=228',
  './js/app-shell.js?v=228',
  './vendor/soundtouch/soundtouch-processor.js?v=228',
  './icons/icon-192.png',
  './icons/icon-512.png',
