importScripts('./app-version.js?v=167');
...
const ASSETS = [
  ...
  './info.css',
  './manifest.json',
  './app-version.js?v=167',
  './cloud-config.js?v=92',
  './cloud-sync.js?v=167',
  './js/audio-runtime.js?v=167',
  './js/core.js?v=167',
  './js/metronome.js?v=167',
  './js/tuner-engine.js?v=167',
  './js/tuner.js?v=167',
  './js/scales.js?v=167',
  './js/ear-trainer.js?v=167',
  './js/rhythm-trainer.js?v=167',
  './js/recording-cache.js?v=167',
  './js/recorder.js?v=167',
  './js/jam-session.js?v=167',
  './js/app-shell.js?v=167',
  './vendor/soundtouch/soundtouch-processor.js?v=167',
  './icons/icon-192.png',
  './icons/icon-512.png',
