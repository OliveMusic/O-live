...
assert.match(index,/service-worker\.js\?v=104/);
assert.match(index,/cloud-sync\.js\?v=97/);
assert.match(worker,/const VERSION = 'v104'/);
...
assert.match(index,/nav\.tabbar button\.sounding::after[\s\S]*left:50%; top:50%; width:40px; height:40px;/);
