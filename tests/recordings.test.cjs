...
assert.match(index,/<summary>\s*<span class="record-history-title">내 녹음<\/span>/);
...
assert.match(index,/\.record-time-track\{[\s\S]*?width:100%; height:3px/);
...
assert.match(recorder,/SOUND_TOUCH_PROCESSOR_URL='\.\/vendor\/soundtouch\/soundtouch-processor\.js\?v=180'/);
...
assert.match(recorder,/if\(recording \|\| startPending\)[\s\S]*?녹음을 정지한 뒤 내 녹음을 재생해 주세요/);
