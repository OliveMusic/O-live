...
assert.match(recorder,/SOUND_TOUCH_PROCESSOR_URL='\.\/vendor\/soundtouch\/soundtouch-processor\.js\?v=168'/);
...
assert.match(recorder,/setActionHandler\('seekbackward'/);
assert.match(recorder,/setActionHandler\('seekforward'/);
