...
assert.match(index,/\.record-time-progress\{[\s\S]*?grid-template-columns:auto minmax\(0,1fr\) auto/);
...
assert.match(recorder,/SOUND_TOUCH_PROCESSOR_URL='\.\/vendor\/soundtouch\/soundtouch-processor\.js\?v=171'/);
