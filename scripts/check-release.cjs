...
const versionedAssets=[
  'cloud-sync.js','js/audio-runtime.js','js/core.js','js/metronome.js','js/tuner-engine.js','js/tuner.js','js/scales.js','js/chord-engine.js','js/chords.js',
  'js/ear-trainer.js','js/rhythm-trainer.js','js/recording-cache.js','js/recorder.js','js/practice-links.js','js/jam-session.js','js/practice-log.js','js/app-shell.js',
];
